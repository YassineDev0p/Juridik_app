...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Superb Arctic Turtle</title>
        <meta property="og:title" content="Superb Arctic Turtle" />
      </Helmet>
      <div className="home-header">
        <header data-thq="thq-navbar" className="home-navbar-interactive">
          <span className="home-logo">Juridik</span>
          ...
          <div data-thq="thq-mobile-menu" className="home-mobile-menu">
            <div className="home-nav">
              <div className="home-top">
                <span className="home-logo1">LAWTRACK</span>
        ...
        <div className="home-hero1">
          <div className="home-container2">
            <h1 className="home-hero-heading heading1">
              Track and Manage Your Legal Practice
            </h1>
            <span className="home-hero-sub-heading">
              client appointments, feedback, legal files, and transactions
            </span>
            <div className="home-container3">
              <Link to="/login" className="home-hero-button1 button">
                Login
              </Link>
